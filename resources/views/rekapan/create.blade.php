...
<div class="card p-4 shadow rounded-3 col-md-6 mx-auto mt-4">
    ...
    <form action="{{ route('rekapan.store') }}" method="POST">
        @csrf
          ...
          <div class="mb-3">
              ...
              <input type="text" name="deskripsi" class="form-control" maxlength="255" value="{{ old('deskripsi') }}" required>
          </div>
          ...
          <a href="{{ route('rekapan.index') }}" class="btn btn-secondary ms-2">Discard</a>
    </form>
</div>
