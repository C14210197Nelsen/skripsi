    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card border-dark shadow-sm mb-3">
                ...
                <div class="card-body"><h3 class="fw-bold">Rp {{ number_format($totalProfit, 0, ',', '.') }}</h3></div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card border-dark shadow-sm mb-3 border border-light">
                ...
                <div class="card-body text-center">
                    ...
                    <hr>
                    <h6>Net Cashflow: 
                        <span class="fw-bold {{ ($cashflow['NetCashflow'] ?? 0) >= 0 ? 'text-success' : 'text-danger' }}">
                            Rp {{ number_format($cashflow['NetCashflow'] ?? 0, 0, ',', '.') }}
                        </span>
                    </h6>
...
@section('scripts')
<script>
    const profitYTD = @json($profitYTD);
