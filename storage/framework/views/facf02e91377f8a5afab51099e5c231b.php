  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top shadow-sm">
        <div class="container-fluid">
            ...
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="d-flex align-items-center ms-auto order-lg-1">
                <?php echo csrf_field(); ?>
            ...
            <div class="collapse navbar-collapse order-lg-0" id="navbarNavDropdown">
                ...
                <?php if(Auth::user()->role === 'Owner'): ?>
                    <?php echo $__env->make('layouts.navbar-owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php elseif(Auth::user()->role === 'Purchase'): ?>
                    <?php echo $__env->make('layouts.navbar-purchase', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php elseif(Auth::user()->role === 'Sales'): ?>
                    <?php echo $__env->make('layouts.navbar-Sales', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
...
</html><?php /**PATH C:\Users\nelse\Herd\skripsi\resources\views/layouts/main.blade.php ENDPATH**/ ?>