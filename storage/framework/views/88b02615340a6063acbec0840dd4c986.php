        ...
        <select name="customer_id" id="customer" class="form-select" required>
          ...
          <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($customer->customerID); ?>"
              <?php echo e(old('customer_id', $salesorder->Customer_customerID) == $customer->customerID ? 'selected' : ''); ?>>
              <?php echo e($customer->customerName); ?><?php echo e($customer->status == 0 ? ' (Nonactive)' : ''); ?>
