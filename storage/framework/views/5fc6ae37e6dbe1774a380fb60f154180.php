    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <div class="mb-3">
          ...
          <input list="supplierList"
                id="supplier"
                class="form-control"
                value="<?php echo e(old('supplier_id') ? optional($suppliers->firstWhere('supplierID', old('supplier_id')))->supplierName : ''); ?>"
                required>
        ...
        <div class="mb-3">
          ...
          <input type="date" name="purchaseDate" id="purchaseDate" class="form-control"
                value="<?php echo e(old('purchaseDate', date('Y-m-d'))); ?>">
        </div>
      </div>
        ...
        <div class="row mb-3 align-items-center">
          <div class="col-3">
            ...
            <select name="isReceived" id="isReceived" class="form-control">
              <option value="0" <?php echo e(old('isReceived') == 0 ? 'selected' : ''); ?>>No</option>
              <option value="1" <?php echo e(old('isReceived') == 1 ? 'selected' : ''); ?>>Yes</option>
            </select>
          </div>
          <div class="col-9">
            <label class="form-label">Received At</label>
            <input type="datetime-local" id="received_at_display" class="form-control" 
                  value="<?php echo e(old('received_at')); ?>" disabled>
            <input type="hidden" name="received_at" id="received_at" value="<?php echo e(old('received_at')); ?>">
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          ...
          <textarea name="description" maxlength="100" class="form-control" rows="5"><?php echo e(old('description')); ?></textarea>
        </div>
      </div>
    </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-2">
              <input type="number" name="products[<?php echo e($index); ?>][cost]" class="form-control cost"
                placeholder="Buy Price" value="<?php echo e($item['cost'] ?? ''); ?>" min="0" required>
            </div>
            <div class="col-md-2">
