...
<?php $__env->startSection('container'); ?>
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
      <a href="<?php echo e(route('customer.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill">Back</a>
    ...
    <tbody class="text-center align-middle">
      <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td>
            <a href="<?php echo e(route('customer.edit', $customer->customerID)); ?>" class="btn btn-sm btn-outline-warning rounded-pill">Edit</a>          </td>
        </tr>
