...
<div class="container">
  ...
  <form action="<?php echo e(route('customer.store')); ?>" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="customerName" name="customerName" value="<?php echo e(old('customerName')); ?>" required>
    </div>
