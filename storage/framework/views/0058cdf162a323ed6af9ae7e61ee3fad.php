...
<div class="container">
  ...
  <form action="<?php echo e(route('user.update', $userlogin->userID)); ?>" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="username" name="username"
        value="<?php echo e(old('username', $userlogin->username)); ?>" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="fullName" name="fullName"
        value="<?php echo e(old('fullName', $userlogin->fullName)); ?>" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <select class="form-select" id="role" name="role" required>
        <?php $__currentLoopData = \App\Models\Userlogin::ROLE_OPTIONS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($role); ?>" <?php echo e(old('role', $userlogin->role) == $role ? 'selected' : ''); ?>>
