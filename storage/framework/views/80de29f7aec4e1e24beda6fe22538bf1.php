...
<?php echo method_field('PUT'); ?>
        ...
        <select name="supplier_id" id="supplier" class="form-select" required>
          ...
          <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($supplier->supplierID); ?>"
              <?php echo e(old('supplier_id', $purchaseorder->Supplier_supplierID) == $supplier->supplierID ? 'selected' : ''); ?>>
              <?php echo e($supplier->supplierName); ?><?php echo e($supplier->status == 0 ? ' (Nonactive)' : ''); ?>
    ...
    <div class="mb-3">
      ...
      <input type="date" name="purchaseDate" id="purcaseDate" class="form-control" value="<?php echo e(old('purchaseDate', \Carbon\Carbon::parse($purchaseorder->purchaseDate)->format('Y-m-d'))); ?>">
    </div>
      ...
      <div class="row mb-2 product-item">
        ...
        <div class="col-md-2">
          <input type="number" name="products[<?php echo e($index); ?>][cost]" class="form-control cost"
            placeholder="Price" value="<?php echo e($item['cost'] ?? ''); ?>" min="0" required readonly>
        </div>
        <div class="col-md-2">
